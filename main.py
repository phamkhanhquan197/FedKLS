...
def main():
    ...
    if dataset_name in ['SetFit/20_newsgroups', 'legacy-datasets/banking77', 'fancyzhx/dbpedia_14', 'stanfordnlp/sst2'] \
        or model_name in ['distilbert-base-uncased', 'roberta-base', 'roberta-large', 'microsoft/deberta-v3-base', 'llama2-7b']:
    ...
    if dyn_cfg.get("enabled", False):
        ...
        log(INFO, "Dynamic data updates enabled. Creating scheduler...")
